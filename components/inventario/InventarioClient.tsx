    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between gap-2 flex-wrap">
        ...
        <div className="flex items-center gap-2 w-full md:w-auto">
          {isAdmin && (
            <button
              onClick={() => window.open('/hoja-inventario', '_blank')}
              title="Hoja de inventario configurable (PDF / Excel): elegís las columnas, incluida una en blanco para el conteo físico"
